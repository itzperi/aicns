...
export const Component: React.FC<{ src: string, alt: string, title?: string }> = ({ src, alt, title }) => {
    return (
        <div >
                ...
                <ImageZoom>
                    ...
                    {title && (
                        <div className="relative -mt-14 bg-gradient-to-b from-black/0 to-black text-white md:-mt-24">
                            <h1 className="z-20 items-center text-center text-[30px] font-black tracking-tighter md:text-[50px] leading-tight px-2">{title}</h1>{' '}
                        </div>
                    )}
                </ImageZoom>
            </div>
